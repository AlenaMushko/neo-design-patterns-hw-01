...
// Знаходимо книги за автором
const booksByAuthor = library.findBooksByAuthor('John Doe');
console.log('Books by John Doe:', booksByAuthor.map(b => b.getDescription()));
